...
class MysteryButton: UIButton {
    ...
    func showImage() {
        self.setBackgroundImage(UIImage(named: self.imageName), for: UIControl.State.normal)
    ...
    func resetMe() {
        ...
        self.setBackgroundImage(UIImage(named: "button"), for: UIControl.State.normal)
